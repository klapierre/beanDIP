...
# #singularity check
# summary(chew_2021_mod)
# ranef(chew_2021_mod) #zeros= bad
# # try running as fixed effect instead of random
# chew_2021_mod2<-lm(chew_pct~seed_coat*as.factor(sampling.round)+variety_name*seed_coat+site,data=filter(damage,year==2021))
# anova(chew_2021_mod2) # site and sampling round signif
...
# # try running as fixed effect instead of random
# stip_2021_mod2<-lm(stip_pct~seed_coat*as.factor(sampling.round)+variety_name*seed_coat+site,data=filter(damage,year==2021))
# anova(stip_2021_mod2) # site and sampling round signif
