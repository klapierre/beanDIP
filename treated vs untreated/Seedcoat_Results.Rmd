...
ggplot(biomass_siteAvgDf,aes(x=seed_treat,y=site_avg_plant_biomass,shape=seed_treat,linetype=seed_treat))+
         geom_line()+ scale_linetype_manual(values=c("dotdash","solid"),labels=c("Treated","Untreated"))+
  geom_point(size=3)+scale_shape_manual(values = c(24,19),labels=c("Treated","Untreated"))+
...
```{r echo=FALSE}
# beans panels
ggplot(biomass_siteAvgDf,aes(x=seed_treat,y=site_avg_beans,shape=seed_treat,linetype=seed_treat))+
         geom_line()+ scale_linetype_manual(values=c("dotdash","solid"),labels=c("Treated","Untreated"))+
  geom_point(size=3)+scale_shape_manual(values = c(24,19),labels=c("Treated","Untreated"))+
